...
function IDataService_processResponse( data_IN )
{
    ...
    var HTML_NO_MATCHES_FOUND = '<div class="Events_ListItem event"><span class=\"vevent\"><div class="eventTitle summary"><div class="eventTitle summary"><p>No matches found for search term.</p></div></span></div>';
    var requestType = '';
    var responseCode = '';
    var responseMessage = '';
    var termList = '';
